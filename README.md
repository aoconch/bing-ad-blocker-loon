...
```
https://cdn.jsdelivr.net/gh/aoconch/bing-ad-blocker-loon@b66389c/Bing-AD-Blocker.plugin
```
...
之后每次插件更新，把 URL 中的 `@b66389c` 换成最新 commit 短哈希即可强制刷新。
...
3. Loon 通过 URL 添加：`https://cdn.jsdelivr.net/gh/<你>/<仓库>@b66389c/Bing-AD-Blocker.plugin`
4. 同上开启 MitM 并信任证书。
